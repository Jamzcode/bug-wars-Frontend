        ...
        <AccordionTab header="OBJECTIVE">
          <div class="objective-container">
            ...
            <div class="text">
              ...
              take over the battleground before the turn counter expires. The species with the most
              specimens when time runs out <span class="high-light">wins!</span>
            </div>
          </div>
        </AccordionTab>
        ...
        <AccordionTab header="BATTLEFIELD">
          <div class="battlefield-container">
            ...
            <div class="text">
              ...
              reproduce itself to victory. <br /><br /><span class="high-light">WALLS -</span>
              Physical barriers found throughout the battle field that obstruct your bug’s movement
              towards food and other bugs. Attack, Eat and Move commands will have no effect on
              these spaces and will result in a spent turn. <br /><br /><span class="high-light"
                >FOOD -</span
              >
              ...
              consequently become food and can then be eaten to generate more of your bug’s species.
            </div>
          </div>
        </AccordionTab>
        ...
        <AccordionTab header="SCRIPT EDITOR">
          <div class="species-script-container">
            ...
            <div class="text">
              ...
              specific element is encountered according to your action statement, the script will
              jump to it’s respective label and execute the presented code. <br /><br /><span
                class="high-light"
